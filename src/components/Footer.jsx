        ...
        <div className="mx-auto max-w-7xl px-6 pb-10 pt-16">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
              ...
              <div>
                <a href="/">
                  <div className="flex items-center space-x-2 text-2xl font-medium">
                    ...
                    <span className="text-gray-800">AIOps</span>
                  </div>
                </a>
              </div>
              <div className="max-w-md pr-16 text-md text-gray-600">
            ...
            <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="text-md font-semibold leading-6 text-gray-800">
                    Our Solutions
                  </h3>
                  <ul role="list" className="mt-6 space-y-4">
                    <li>
                      <a
                        href="/aiplatform"
                        className="text-md leading-6 text-gray-600 hover:text-gray-800"
                      >
                        AI Platform
                      </a>
                    </li>
          ...
          <div className="mt-16 border-t border-gray-400/30 pt-8 sm:mt-20 lg:mt-24">
            <div className="text-md text-center text-gray-800">
              ...
              <span className="text-gray-600"> ♥ </span> by AI enthusiasts at
              <a rel="noopener" href="/">
                {" "}
                AIOps.
              </a>
